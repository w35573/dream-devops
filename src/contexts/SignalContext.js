...
Like play video, pause video etc. Whenever one of these events are fired,
the global context data is updated which inturn fires different Video Player
related functions using useEffect(). 

For example, when PLAY_VIDEO event is triggered, 'playVideo' will update with 
